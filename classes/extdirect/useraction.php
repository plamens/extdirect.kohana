 ...
 * @author     Fady Khalife
 */
//sleep(1); // Fake some loading
class ExtDirect_UserAction extends Controller_ExtDirect
{
    /**
    ...
    */
    function direct_get($start=0, $limit=10, $sort='first', $dir='ASC')
    {
